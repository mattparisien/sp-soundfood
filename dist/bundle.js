...
"use strict";
/* harmony import */ var _tools_App_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(608);



const init = async () => {
  const app = new _tools_App_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z();
};
...
/* harmony export */ });
/* harmony import */ var _Interface_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(826);
...
class Audio extends _Module_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z {
  constructor(wrapper) {
    super();
    this.el = wrapper;
  ...
  initListeners() {
    ...
    nodes.forEach((node) => {
      ...
      dataset.forEach((set) => {
        ...
        d.forEach((x) => {
          const m = _Module_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.modules.filter((m) => m.name == x[0].trim())[0];
...
class Module {
  ...
  setContainerId() {
    this.container?.setAttribute(
      `data-module-${this.name.toLowerCase()}`,
      lodash__WEBPACK_IMPORTED_MODULE_0___default().uniqueId("m")
    );
  }
...
/* harmony export */ });
/* harmony import */ var _Module_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(617);
/* harmony import */ var _PodcastApi_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(906);
...
;// CONCATENATED MODULE: ./src/tools/PodcastApi.js



class PodcastApi extends Module/* default */.Z {
  constructor() {
    super();
    ...
    this.limit = 100;
    this.proxyUrl = "https://sf-proxy-200fa2f17b47.herokuapp.com/episodes";
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksoundfood"] = self["webpackChunksoundfood"] || [];
